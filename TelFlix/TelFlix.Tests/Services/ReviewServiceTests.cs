...
namespace TelFlix.Tests.Services
{
    ...
    public class ReviewServiceTests
    {
        ...
        //[TestMethod]
        //public void GetAllByUserId_Should_WorkCorrect()
        //{
        //    var db = new TFContext(DatabaseSimulator());
        //    var userManager = new Mock<UserManager<User>>(
        //        Mock.Of<IUserStore<User>>(), null, null, null, null, null, null, null, null);
        ...
        //        Id = "UserId"
        //    };
        //    var reviewOne = new Review() { UserId = "UserId" };
        //    var reviewTwo = new Review() { UserId = "UserId" };
        //    var reviewThree = new Review() { UserId = "User" };
        //    db.Reviews.Add(reviewOne);
        //    db.Reviews.Add(reviewTwo);
        //    db.Reviews.Add(reviewThree);
        //    db.Users.Add(user);
        ...
        //    Assert.AreEqual(2, reviewServices.GetAllByUserId("UserId").Count());
        //}
